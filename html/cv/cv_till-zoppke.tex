...
\header{t~i~l~l~~}{zoppke}{computer scientist, teacher} % Your name and current job title/field
...
\section{contact}
\href{http://kinnla.de}{{\color{dark-gray}\faHome} kinnla.de}
\href{mailto:kinnla@posteo.de}{{\color{dark-gray}\faEnvelope} kinnla@posteo.de}
\href{https://keybase.io/kinnla}{{\color{dark-gray}\faKey} keybase.io/kinnla}
\href{https://twitter.com/kinnla}{{\color{dark-gray}\faTwitter} kinnla}
{\color{dark-gray}\faSkype} kinnla
%
\section{languages}
...
%
\section{programming}
\href{https://github.com/kinnla}{{\color{dark-gray}\faGithub} kinnla}
%{\color{red} $\varheartsuit$} JavaScript
java, c\#, c++, c, assembler, python, haskell, lua, xml, \LaTeX
%
\section{tools}
eclipse, visualstudio, git, slack, trello, sakai, moodle, ushahidi, civicrm
%
\section{it security}
...
traveling, diving, photography, s-pedelecs, zen-meditation
%
\end{aside}
